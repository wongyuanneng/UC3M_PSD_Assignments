...
public class RevokeTokenTest {
    ...
    @Test
    /* Test Case: RevokeToken_EC_V01
     * Equivalence class: <Valid Temporal>
    ...
    @Test
    /* Test Case: RevokeToken_EC_V02
     * Equivalence class: <Valid Final>
     * Testing method: <Equivalence class>
    ...
    @Test
    /* Test Case: RevokeToken_EC_IV13
     * Equivalence class: <Invalid With Large Reason>
     * Testing method: <Equivalence class>
     * Expected result: <TokenManagementException "Error: input file not found.">
     */
    void RevokeToken_EC_IV13() throws TokenManagementException {
     ...
     */
    void RevokeToken_EC_IV14() throws TokenManagementException {
    ...
    @Test
    /* Test Case: RevokeToken_EC_IV15
     * Equivalence class: <Invalid With Non JSON file>
     * Testing method: <Equivalence class>
     * Expected result: <TokenManagementException "Error: JSON object cannot be created due to incorrect representation">
     */
    void RevokeToken_EC_IV15() throws TokenManagementException {
