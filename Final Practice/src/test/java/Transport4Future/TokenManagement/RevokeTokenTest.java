...
public class RevokeTokenTest {
    ...
    void EC_V01() throws TokenManagementException {
        ...
        String Result1 = "autonomous@vehicle.com";
        String Result2 = "Error: Token previously revoked by this method.";
        String myResult;
        try {
            myResult = myManager.RevokeToken(InputFilePath);
            if (myResult instanceof String) {
                ...
                Assertions.assertEquals(Result1,myResult);
            } else {
                Assertions.fail("Error: Output is not a string");
            }
        } catch (TokenManagementException ex) {
            Assertions.assertEquals(Result2,ex.getMessage());
        }
    }
